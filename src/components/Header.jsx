...
import appLogo from '../assets/images/mitorrents_logo_1788332424314.jpg';
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0 cursor-pointer" onClick={() => { setActiveTab('latest'); setSearchQuery(''); }}>
            <img
              src={appLogo}
              alt="MiTorrents Logo"
              className="w-10 h-10 rounded-xl object-cover shadow-lg shadow-cyan-500/20 border border-slate-200 dark:border-slate-800"
