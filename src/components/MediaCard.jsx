...
export default function MediaCard({
  ...
  const handleOpenMagnet = (e) => {
    e.stopPropagation();
    openMagnetInClient(item);
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[16/10] sm:aspect-[4/3] bg-slate-100 dark:bg-slate-950 overflow-hidden">
        <img
          src={!imageError ? getValidPosterUrl(item.image) : defaultPoster}
          alt={item.title}
          loading="lazy"
        ...
        <div className="pt-2 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              title={copiedMagnet ? "Magnet Opened & Copied!" : "Open Magnet in Torrent Client (Copies Link)"}
            >
